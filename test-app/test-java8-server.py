...
def test_java8_notification_to_server():
    send_notification_to_server("Java 8", URL_TO_ITSELF, 1000)
    time.sleep(5)
    ...
    send_notification_to_server("Java 8", URL_TO_ITSELF_V2, 1000)
    time.sleep(5)
    ...
    send_notification_to_server("Java 8", URL_TO_ITSELF_V3, 1000)
    time.sleep(5)
