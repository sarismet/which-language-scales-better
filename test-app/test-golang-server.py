...
def test_golang_notification_to_server():
    send_notification_to_server("Golang", URL_TO_ITSELF, 1000)
    time.sleep(10)
    send_notification_to_server("Golang", URL_TO_JAVA8_SERVER, 1000)
    time.sleep(10)
    send_notification_to_server("Golang", URL_TO_GOLANG_SERVER, 1000)
